...
public class StartPanel extends JPanel
{
  ...
  public StartPanel(CelebrityGame controller)
  {
    ...
    this.actorClue = "Enter clues for the actor: their number of Academy Awards, age, nationality, ect.";
  ...
  {
    answerField.setText("Type in the celebrity correctly!!");
    answerField.setBackground(Color.RED);
    clueField.setText("Type in the clue correctly!!");
